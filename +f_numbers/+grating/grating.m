...
classdef (Abstract) grating < f_numbers.f_number
	...
	properties (SetAccess = private)
        ...
        anti_aliasing_tf ( 1, 1 ) boolean { mustBeNonempty, mustBeNonnegative } = true % include anti-aliasing filter
...
%                 objects( index_object ).anti_aliasing = anti_aliasing_tfs( index_object );
