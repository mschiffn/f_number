%
% superclass for all obliquity factors for a rigid baffle
%
% author: Martin F. Schiffner
% date: 2022-01-08
% modified: 2022-01-08
%
classdef rigid < f_numbers.directivity.obliquity.obliquity
    ...
    methods
        ...
        function objects = rigid( size )
            ...
            %--------------------------------------------------------------
            % 2.) create obliquity factors for a rigid baffle
            %--------------------------------------------------------------
            % constructor of superclass
            objects@f_numbers.directivity.obliquity.obliquity( size );

        end % function objects = rigid( size )
    ...
    methods (Access = protected, Hidden)
        ...
        function values = compute_values_scalar( ~, theta )
            ...
            % 1.) check arguments
            %--------------------------------------------------------------
            % calling method ensures class f_numbers.directivity.obliquity.obliquity for rigid (scalar)
            % calling method ensures valid theta

            %--------------------------------------------------------------
            % 2.) compute values (scalar)
            %--------------------------------------------------------------
            values = ones( size( theta ) );
...
end % classdef rigid < f_numbers.directivity.obliquity.obliquity
